...
public class Jogador {
    ...
    public Jogador(Long id, String nome, Sexo sexo, int idade, double altura, double peso, String posicao, int numeroCamisa) {
        this.id = id;
        this.nome = nome;
        this.sexo = sexo;
        this.idade = idade;
    ...
    public @NotNull(message = "Sexo é obrigatório.") Sexo getSexo() {
        return sexo;
    }

    public void setSexo(@NotNull(message = "Sexo é obrigatório.") Sexo sexo) {
        this.sexo = sexo;
    }
